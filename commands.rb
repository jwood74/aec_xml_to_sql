		...
		cont.children.each do | ddd |
			...
			if res_address.nil?
				...
				if ress_add_lin1.nil?
					...
					ress_add_lin1 = ress_add_lin1.text
				end

				if ress_add_lin2.nil?
					ress_add_lin2 = ''
				else
					ress_add_lin2 = ress_add_lin2.text
				end
			end
			...
			if post_address.nil?
				...
				if post_add_lin1.nil?
					...
					post_add_lin1 = post_add_lin1.text
				end

				if post_add_lin2.nil?
					post_add_lin2 = ''
				else
					post_add_lin2 = post_add_lin2.text
				end
			end
...
def process_house
	...
	contests.children.each do | contest |
		...
		polplaces.children.each do | polplace |
			...
			firstprefs.children.each do | fpref |
